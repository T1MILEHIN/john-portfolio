        ...
        <div>
            <div className="lg:px-20 px-2">
                <div className="lg::p-20 px-2 py-10">
                    <div className="flex lg:flex-row flex-col md:gap-10 gap-20 items-center">
                ...
                <div className="sm:p-2 lg:p-20 py-10 p-2 flex flex-col gap-20">
                    <h1>RECENT WORKS</h1>
                    <div>
                        <Table>
                            <TableHeader>
                ...
                <div className="flex flex-wrap md:flex-nowrap gap-10 md:p-20 p-2">
                    <div>
                        ...
                        <div className="py-6 border-y-2 border-[#C6C3C3] flex flex-col gap-4">
                            ...
                            <p className="text-darkbg leading-9 text-xs">Johnbeloved transformed our interface into a visually stunning experience. Their attention to detail and understanding of our brand made the collaboration seamless. Highly recommended!</p>
                        </div>
                    </div>
                    <div>
