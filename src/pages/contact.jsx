                            ...
                            <div className="flex flex-col gap-5">
                                ...
                                <div className="flex md:gap-5 items-end">
                                    ...
                                    <div className="flex-1 flex flex-col gap-1">
                                        ...
                                        <Select className="">
                                            <SelectTrigger className="w-full h-12 outline-none border-none border-b-2 border-[#1b1b1b]">
                                ...
                                <div className="flex md:gap-5 items-end">
                                    ...
                                    <div className="flex-1 flex flex-col gap-1">
                                        ...
                                        <textarea type="text" name="" id="" placeholder="Hello john i want you to help me with" className="resize-none pl-2 w-full bg-transparent border-b-2 border-[#1b1b1b]"></textarea>
                                    </div>
                                </div>
            
                            </div>
                            <div className="relative text-right my-32 md:py-0">
                                <button className="absolute right-20 top-1/2 -translate-y-1/2 z-10 button rounded-[40px] bg-blue text-white">Get In Touch</button>
