    ...
    <div>
      <div className="md:px-20">
        <div className="md:py-20">
          <h1 className="w-[842px] text-5xl leading-[80px]">Helping Brands Stand Out with Unique Design</h1>
        </div>
        <hr className="border-[#636363]" />
      </div>
      <div className="flex gap-10 md:p-20 p-2">
        <div className="flex flex-col gap-10 text-[#2E2A2A]">
          ...
          <button className="mx-auto z-10 py-12 px-5 rounded-[40px] bg-[#407BFF] text-white w-fit">Get In Touch</button>
        </div>
        <img src={img} alt="" />
      </div>
      ...
      <div className="md:p-20">
        ...
        <p className="text-[#2E2A2A] text-[15px] leading-[20px]">In my 5years experience as a designer, I’ve been employed by different companies and worked together with various clients. Therefore, I’ve had the opportunity to explore more than one branch of design and built up a series of additional skills that I am now able to bring with me in a UX/UI role:</p>
